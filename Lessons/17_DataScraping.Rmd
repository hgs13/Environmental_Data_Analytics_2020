...
# Reading the HTML code from the website, makes it reusable
...
State <- webpage %>% html_nodes("table:nth-child(20) td:nth-child(1)") %>% html_text() #visit this webpage, find these nodes, then read it in as text
...
> The larger the area assessed the more impairment there is.
...
ggplot(Estuary, aes(x = Estuaries.Assessed.mi2, y = Estuaries.Impaired.mi2, 
  ...
  #            aes(label = State), nudge_x = -500, nudge_y = 200) + #can have just geom_label if repel isn't working
  #
