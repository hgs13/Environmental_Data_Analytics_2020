...
```{r}
a <- c("Kitiara" , "Riverwind" , "Goldmoon" , "Tika") #character vector
b <- c(95, 83, 68, 45) #numerical vector
c <- c(TRUE, TRUE, TRUE, FALSE) #logical vector
testscores <- data.frame(a, b, c)
...
> Answer: 'ifelse' worked because 'if' and 'else' can only read one object.
